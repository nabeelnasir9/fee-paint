      ...
      <div className="pages-data-container">
        <Grid container spacing={0}>
          ...
          <Grid xs={10} sm={10} md={10} lg={10} xl={8}>
            ...
            <p className="privacy-policy-title">OVERVIEW </p>
            <p className="privacy-policy-text">
              This website is operated by My Paint Genie. Throughout the site,
              the terms “we,” “us,” and “our” refer to My Paint Genie. My Paint
              Genie offers this website, including all information, tools, and
            ...
            <p className="privacy-policy-text">
              ...
              <Link to="/refund-policy" className="linking">
                Refund policy – My Paint Genie
              </Link>
            </p>
            <p className="privacy-policy-title">SECTION 7 - OPTIONAL TOOLS</p>
            <p className="privacy-policy-text">
              ...
              entirely at your own risk and discretion. You should ensure that
            ...
            <p className="privacy-policy-title">SECTION 12 - PROHIBITED USES</p>
            <p className="privacy-policy-text">
            ...
            <p className="privacy-policy-text">
              ...
              non-infringement.
              <br />
              In no case shall My Paint Genie, our directors, officers,
            ...
            <p className="privacy-policy-title">SECTION 14 - INDEMNIFICATION</p>
            <p className="privacy-policy-text">
              You agree to indemnify, defend and hold harmless My Paint Genie
            ...
            <p className="privacy-policy-title">SECTION 15 - SEVERABILITY</p>
            <p className="privacy-policy-text">
            ...
            <p className="privacy-policy-title">SECTION 16 - TERMINATION</p>
            <p className="privacy-policy-text">
            ...
            <p className="privacy-policy-title">SECTION 18 - GOVERNING LAW</p>
            <p className="privacy-policy-text">
